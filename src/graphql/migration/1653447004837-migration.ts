...
export class migration1653447004837 implements MigrationInterface {
    name = 'migration1653447004837'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`user\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleteAt\` datetime(6) NULL, \`email\` varchar(255) NOT NULL, \`displayName\` varchar(255) NOT NULL, \`photoURL\` varchar(255) NOT NULL, \`firebaseUid\` varchar(255) NOT NULL, \`lineUserId\` varchar(255) NOT NULL, \`active\` varchar(255) NOT NULL, \`role\` enum ('admin', 'user') NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
